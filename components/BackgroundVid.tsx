  ...
  return (
    <div className="relative h-[65vh] w-full overflow-hidden bg-black sm:h-[80vh]">
      ...
      <div
        ...
        className="absolute bottom-0 left-0 right-0 flex h-[35vh] flex-col items-center justify-center bg-gradient-to-b from-transparent via-background to-red-100 p-4 pt-48 text-center text-foreground dark:to-red-950"
      >
